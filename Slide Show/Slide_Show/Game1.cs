...
namespace Slide_Show
{
    ...
    public class Game1 : Microsoft.Xna.Framework.Game
    {
        ...
        protected override void LoadContent()
        {
            ...
            ReadInts(@"Content/rectangle data.txt");
        }

        private void ReadInts(string path)
        {
            try
            {
        ...
        protected override void Update(GameTime gameTime)
        {
            ...
            screenRct = new Rectangle((window.Width / 2) - (rects[current].Width / 2),(window.Height / 2) - (rects[current].Height / 2), rects[current].Width, rects[current].Height);
